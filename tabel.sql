...
CREATE TABLE `data_laporan_kib_a` (
  `id` int(11) NOT NULL auto_increment,
  `id_tanah` varchar(255) DEFAULT NULL,
  ...
  `nilai_perolehan` varchar(255) DEFAULT NULL,
...
CREATE TABLE `data_laporan_kib_b` (
  `id` int(11) NOT NULL auto_increment,
  `id_mesin` varchar(255) DEFAULT NULL,
  `kode_skpd` varchar(255) DEFAULT NULL,
  `nama_skpd` varchar(255) DEFAULT NULL,
  ...
  `nilai_dasar_perhitungan` varchar(255) DEFAULT NULL,
  `nilai_penyusutan_per_tahun` varchar(255) DEFAULT NULL,
  `nilai_penyusutan` varchar(255) DEFAULT NULL,
...
CREATE TABLE `data_laporan_kib_d` (
  `id` int(11) NOT NULL auto_increment,
  `id_jalan_irigasi` varchar(255) DEFAULT NULL,
  `kode_skpd` varchar(255) DEFAULT NULL,
  `nama_skpd` varchar(255) DEFAULT NULL,
  `nama_unit` text DEFAULT NULL,
  `kode_unit` varchar(255) DEFAULT NULL,
...
CREATE TABLE `data_laporan_kib_e` (
  `id` int(11) NOT NULL auto_increment,
  `id_aset_tetap` varchar(255) DEFAULT NULL,
  `kode_skpd` varchar(255) DEFAULT NULL,
  `nama_skpd` varchar(255) DEFAULT NULL,
  `nama_unit` text DEFAULT NULL,
  `kode_unit` varchar(255) DEFAULT NULL,
